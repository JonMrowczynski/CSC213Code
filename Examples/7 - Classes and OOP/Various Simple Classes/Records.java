...
void displaySpaceTimePoints() {
    IO.println("Comparing SpaceTimePoints: ");
    final var point1 = new SpaceTimePoint(1, 1, 1, 0);
    IO.println("point1: " + point1);
    IO.println("Have to call getter: " + point1.getX() + " to access field values.");
    final var point2 = new SpaceTimePoint(1, 1, 1, 0);
    final var point3 = new SpaceTimePoint(1, 2, 3, 4);
    IO.println("point1.equals(point2) ? -> " + point1.equals(point2));
    IO.println("point1.equals(point3) ? -> " + point1.equals(point3));
}

void displaySpaceTimePointRecords() {
    IO.println("Comparing SpaceTimePointRecords: ");
    final var point1 = new SpaceTimePointRecord(1, 1, 1, 0);
    IO.println("point1: " + point1);
    IO.println("Can either call field: " + point1.x + " or the getter: " + point1.x() + " to access field values since immutable!");
 ...
 * @author Jon Mrowczynski
 */
record SpaceTimePointRecord(double x, double y, double z, double t) { 
