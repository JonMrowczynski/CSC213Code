...
void main() {
    ...
    IO.println("Truncated camel-cased variable: " + myTruncatedCamelCasedVariable);
    IO.println();

    // Sometimes variables are casted implicitly!
    IO.println("Implicit cast: " + 3 * 4.0); // Here the 3 gets implicitly casted to a floating-point value!
    ...
    IO.println("Big Integer sum: " + bigInt.add(bigInt));
    IO.println();

    IO.println("Square root of 4: " + Math.sqrt(4));
}
