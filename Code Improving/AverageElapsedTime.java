...
void main() {
	...
	IO.println("Result from averageElapsedTimeSimple: " + simpleResult);
	IO.println("Result from averageElapsedTimeComplex: " + complexResult);
}

double averageElapsedTimeComplex(final int numTimes, final long elapsedTime) {
	if (numTimes == 0) {
		return 0;
	} else {
 ...
 */
double averageElapsedTimeSimple(final int numTimes, final long elapsedTime) {
	/*
